## TIY 12.5 Sideway shooter
# Add another side shooter to move up and down
import pygame
...
class ShipSide():
    ...
    def __init__(self, ai_settings, screen):
        """Initialize the side ship and set its starting position."""
        self.screen = screen
        
        # Load the ship image and get it rect.
        self.image = pygame.image.load("images/kobo.bmp")
